...
function openSend2GpsFunctionLocal(){
  return function(){
    var url = 'https://www.geocaching.com/seek/sendtogps.aspx?guid=9d2b4990-7222-4b1c-8062-8b753af24ac5&tour=true',
...
function openSend2GpsDialog(){
  if(isLogedIn() && isNotEmptyList()){
    ...
    overlay.innerHTML = "<iframe src='https://www.geocaching.com/seek/sendtogps.aspx?guid=9d2b4990-7222-4b1c-8062-8b753af24ac5&tour=1' width='450px' height='350' scrolling='no' marginheight='0' marginwidth='0' frameborder='0'></iframe>";
  }
}
...
function addElementFunction(theId, theGuId, theName, theTypeImage){
  return function (event) {
    ...
    if(!isIdInTable(theId)){
      ...
      var typeGif = theTypeImage.replace("http://www.geocaching.com/images/WptTypes/sm/", ""); // ggf. schon komplette url k�rzen
